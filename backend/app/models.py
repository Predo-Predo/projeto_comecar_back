...
class Empresa(Base):
    ...
    logo_empresa_url  = Column(Text, nullable=True)   # ≪ campo específico para a logo da empresa ≫
...
class App(Base):
    ...
    logo_app_url        = Column(Text, nullable=True)  # ≪ campo específico para a logo do app ≫
    app_key             = Column(Text, nullable=False, unique=True)
